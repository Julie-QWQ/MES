<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="rtsalselineList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="退货数量" align="center" prop="quantityRt" />
      ...
      <el-table-column label="有效期" align="center" prop="expireDate" width="100">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="退货数量" prop="quantityRt">
              <el-input-number :min="0.01" v-model="form.quantityRt" placeholder="请输入退货数量" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="退货批次号" prop="batchCode">
              <el-input v-model="form.batchCode" placeholder="请输入退货批次号" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        warehouseId: [
          { required: true, message: "请选择退货的仓库" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除退货单行编号为"' + lineIds + '"的数据项？').then(function() {
